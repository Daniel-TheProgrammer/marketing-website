      ...
      <div className=" pt-[120px]">
        <div className="flex flex-col items-center container mx-auto">
          ...
          <div className="w-[573px] min-h-[73px] border-[1px] border-[#CACACA] rounded-[20px] bg-white pl-[21px] pr-[8px] flex items-center mt-[48px] mb-[45px]">
            ...
            />
            <button
              className="outline-none border-none min-h-[56px] w-[173px] items-center justify-center rounded-[12px] flex text-center itemss-center bg-[#1D2130] text-white leading-[150%] text-[16px]"
